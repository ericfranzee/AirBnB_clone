...
This project is a console for an AirBnb clone site. It is a back door for administrators to manage data and other functionalities. The console allows for the manipulation of a database (either file-based or SQL-based) using Python and the cmd library.

## Files Class

The first Files are the once containing the clases and 
all of them ar found in the models directory as part of the module. example;
- **User**: This class represents a user that can be either an owner or a guest.
...
## Console :computer:
A console is provided for testing purposes. It allows users to interactively create, read, update, delete (CRUD) objects from the database

All console interaction is managed through the [Console](./console.py) class.
This includes user input, output, error messages, logging, etc. All methods  
of this class should print something to the standard output stream (usually your  terminal).
The AirBnb clone console is a command-line interpreter designed to manage the backend of an AirBnb-like site. It can be used to handle and manipulate all classes utilized by the application, thanks to calls on the storage object.
...
': '6f348019-0499-420f-8eec-ef0fdc863c02'}
(hbnb)
(hbnb) User.update(6f348019-0499-420f-8eec-ef0fdc863c02, {'email': 'ALX@h
olberton.com', 'last_name': 'School'})
[User] (6f348019-0499-420f-8eec-ef0fdc863c02) {'email': 'ALX@ALX.co
...
```
git clone https://github.com/ericfranzee/AirBnB_clone.git
```
...
* **Ericfranzee** [Ericfranzee](ericfranzee@gmail.com)
